...
const Layout = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-dark-900 transition-colors duration-300 flex flex-col font-sans">
            <Navbar />
            <main className="flex-1 w-full mt-20 sm:mt-24">
            ...
            <footer className="w-full bg-white dark:bg-dark-800 border-t border-gray-100 dark:border-dark-700 py-8 mt-auto">
